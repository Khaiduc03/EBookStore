...
export const ENDPOINTS = {
  ...
  //COMMENT_FORUM
  COMMENT_FORUM: Config.COMMENT_FORUM,
  LIKE_COMMENT_FORUM: Config.LIKE_COMMENT_FORUM,
  UNLIKE_COMMENT_FORUM: Config.UNLIKE_COMMENT_FORUM,
  REP_COMMENT_FORUM: Config.REP_COMMENT_FORUM,
