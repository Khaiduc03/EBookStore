    ...
    <View style={styles.container}>
      <ScrollView nestedScrollEnabled showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.textDescribe}>
          ...
          provides a gadget to help Nobita solve his problems, or sometimes just
          to get back at or show off to his friends. Nobita often ends up going
          too far with Doraemon's gadgets, sometimes even creating bigger
          problems than before, especially with newly introduced gadgets.
          Sometimes, Nobita's friends, usually Shizuka or Gian, steal the
          gadgets and use them for the wrong purposes. However, typically, at
          the end of each story, those who misuse the gadgets face the
