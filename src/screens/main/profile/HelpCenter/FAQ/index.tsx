        ...
        <View>
          ...
          <View style={styles.Toggleable}>
            <View style={styles.viewToggleable}>
              <Toggleable initialText="Comic Verse là gì ?" iconColor="#f89300" initialContent='Comic Verse là một ứng dụng độc đáo kết hợp mạng xã hội và việc đọc truyện tranh. Kết nối với cộng đồng yêu thích truyện tranh, chia sẻ, tương tác và tận hưởng hàng ngàn truyện tranh đa dạng, từ hài hước đến kinh dị. Dễ sử dụng và thú vị!' />
            </View>
            <View style={styles.viewToggleable}>
              <Toggleable initialText="Làm thế nào để trở thành thành viên VIP của Comic Verse ?" iconColor="#f89300" initialContent='Nạp tiền vào là có VIP ^__^ !!!!!!!!!!!!!!!!!!!!!!!!!!' />
            </View>
            <View style={styles.viewToggleable}>
              <Toggleable initialText="Làm thế nào để trở thành thành viên VIP của Comic Verse ?" iconColor="#f89300" initialContent='Nạp tiền vào là có VIP ^__^ !!!!!!!!!!!!!!!!!!!!!!!!!!' />
            </View>
